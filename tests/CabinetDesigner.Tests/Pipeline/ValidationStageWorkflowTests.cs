...
public sealed class ValidationStageWorkflowTests
{
    [Fact]
    public void Execute_WorkflowSnapshot_ReflectsDraftState_WhenNoProject()
    {
        ...
        Assert.False(capturedContext.WorkflowState.HasPendingManufactureBlockers);
    }
    ...
    {
        var projectId = new ProjectId(Guid.Parse("80000000-0000-0000-0000-000000000002"));
        var revisionId = new RevisionId(Guid.Parse("70000000-0000-0000-0000-000000000002"));
    ...
    private sealed record TestDesignCommand : IDesignCommand
    {
        public CommandMetadata Metadata { get; } =
            CommandMetadata.Create(DateTimeOffset.UnixEpoch, CommandOrigin.User, "Validation Workflow Test", []);

        public string CommandType => "test.validation_workflow";
